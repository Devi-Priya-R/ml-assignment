...
model_white.add(Dense(10,activation="relu",input_shape=(11,) ))
model_white.add(Dense(10,activation="relu"))
model_white.add(Dense(10,activation="relu"))
model_white.add(Dense(1))
model_white.compile(optimizer="adam",loss="mse",metrics=["mae"])
model_white.fit(x_train,y_train,epochs=50)
print("Training completed")
#save the model
model_white.save("white_model.keras")
joblib.dump(scaler,"scaler_white.pkl")
#evaluate the model
test_result=model_white.predict(x_test)
